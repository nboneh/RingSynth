//
//  AxonixFullScreenAdViewController.h
//  Axonix iOS SDK
//
...
@protocol AxonixFullScreenAdDelegate;
@interface AxonixFullScreenAdViewController : UIViewController {
 ...
 */
@property(nonatomic,weak) id<AxonixFullScreenAdDelegate> delegate;
@end

@protocol AxonixFullScreenAdDelegate<NSObject>
@optional
...
/**
 * This is called when an ad failed to load.  The error codes will match up with the codes in AxonixAdView.h
 */
