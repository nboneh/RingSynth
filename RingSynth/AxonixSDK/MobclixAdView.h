 ...
 */
@property(nonatomic,weak) IBOutlet id<MobclixAdViewDelegate> delegate;
...
__deprecated_msg("Use AxonixAdViewiPhone_320x50 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
@interface MobclixAdViewiPhone_320x50 : MobclixAdView {}
@end

__deprecated_msg("Use AxonixAdViewiPhone_300x250 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
...
__deprecated_msg("Use AxonixAdViewiPad_300x250 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
@interface MobclixAdViewiPad_300x250 : MobclixAdView {}
@end

__deprecated_msg("Use AxonixAdViewiPad_728x90 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
@interface MobclixAdViewiPad_728x90 : MobclixAdView {}
@end

__deprecated_msg("Use AxonixAdViewiPad_120x600 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
@interface MobclixAdViewiPad_120x600 : MobclixAdView {}
@end

__deprecated_msg("Use AxonixAdViewiPad_468x60 instead. You'll need to import the AxonixAds.h header instead of MobclixAds.h")
