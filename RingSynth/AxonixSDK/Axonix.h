...
typedef enum {
    AXN_LOG_LEVEL_VERBOSE =	1 << 0,
	AXN_LOG_LEVEL_DEBUG =	1 << 1,
	AXN_LOG_LEVEL_INFO	=	1 << 2,
	AXN_LOG_LEVEL_WARN	=	1 << 3,
	AXN_LOG_LEVEL_ERROR	=	1 << 4
	
} AxonixLogLevel;

@class CLLocation;
@interface Axonix : NSObject {
...
/**
 * Version of this Axonix iOS SDK.
 *
 */
+ (NSString*) version;
